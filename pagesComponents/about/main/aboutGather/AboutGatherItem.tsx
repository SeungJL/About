...
import GatherMainItemParticipants from "./gatherMainItem/GatherMainItemParticipants";
import GatherMainItemStatus from "./gatherMainItem/AboutMainItemStatus";
    ...
    >
      {participation && (
        <>
          ...
          <SpaceInfo>
            <GatherMainItemStatus place={place} status={status} />
            <Info>{place.brand}</Info>
            <GatherMainItemParticipants
