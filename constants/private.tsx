...
export const PROMOTION_TEXT = `안녕하세요! 저희는 카공 스터디로 시작했다가 어쩌다보니 친목 활동까지 같이 하게 된 200명 이상 규모의 동아리 About입니다! 카공이 주된 목적이지만, 근처에 사는 새로운 또래 친구들을 만날 수도 있는 동아리입니다. 공부를 목적으로 하시는 분도, 공부와 함께 친목을 목적으로 하신는 분도 모두 환영합니다! 😊
