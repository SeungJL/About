  ...
  mainContent: [
    {
      ...
      texts: [
        "누구나 소모임에 참여하거나 새로 개설할 수 있습니다. 다만 모집이 만료되거나 그룹장 승인이 필요한 경우, 가입 조건이 존재하는 경우 참여가 제한될 수 있습니다.",
    ...
    },
    {
      ...
      texts: [
        "대부분의 경우 단톡방에서 활동이 진행됩니다. 웹사이트에서는 참여중인 멤버들의 관리와 홍보, 출석체크, 메모장처럼 쓰이는 채팅, 여러 기능이 있는 모임 진행이 가능합니다.",
      ],
    },
    {
      title: "가입할 때 필요한게 있나요?",
      texts: [
        "기본 참여금으로 30 포인트(또는 200원)이 필요합니다. 모임에 따라 가입에 참여비가 요구되는 경우가 있을 수 있고, 금액과 목적은 가입 신청시 공지되어 있습니다.",
      ],
    },
  ],
};
