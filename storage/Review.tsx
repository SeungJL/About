...
export const REVIEW_DATA: IReviewData[] = [
  ...
  },
  {
    ...
    text: "저녁을 같이 먹고 강남역에 있는 무제한 칵테일바에 갔어요! 안주 반입이 가능해서 편의점 과자랑 함께했답니다 ㅎㅎ 과자 사오라고 했더니 그들의 초이스는 뻥이요, 계란과자, 건빵... 어딘가 세대를 건너간 듯한 초이스지만 생각보다 너무 맛있더라고요! 초중반에는 칵테일만 먹었는데, 다 도수가 엄청 약하더라고요...! 끊임없이 계속 시켜서 사장님께 미안한 마음... 나중에는 그냥 샷으로 마셨어요 ㅎㅎ 토닉워터도 섞어서! 막차까지 게임도 하고, 얘기도 많이 하고 시간가는 줄 몰랐던 번개였습니당",
  },
];
