...
export const NOTICE_ARR: INoticeArr[] = [
  ...
  },
  {
    ...
    category: "main",
    content:
      "양천 - 목동점/발산역 스타벅스, 동대문 - 화랑대역 마르티. 스터디 장소 추천을 받아서 추가했습니다. 추가적으로 월간 출석체크는 단톡방에서 공지하도록 하겠습니다. 미참여 인원은 벌금이 부여되고, 특별한 사유로 인한 휴식을 제외하고 2달 연속 미참여는 추방됩니다. + 리모델링을 또 한번 준비중이라 최근에 운영 관련 공지는 많이 안하고 있습니다. 개강하면 또 몇가지 바뀔 수 있어요!",
    date: "2023-02-05",
  },
];
