...
export const NOTICE_ARR: INoticeArr[] = [
  ...
  },
  {
    ...
    category: "main",
    content:
      "이번 겨울 방학 시즌에는 스터디/소모임을 진행합니다! 스터디를 운영해주시는 분께는 5만원 정도 상당의 사례금을 드리고, 열심히 참여하는 멤버분들한테도 소소한 상품이 있을 예정입니다. 아직 어떤 소모임들을 열지는 확정되지 않아서 어떤 분야에 다들 관심이 있으신지 사전 희망 조사를 진행하겠습니다! 추가로 진행하고 싶은 스터디가 있다면 항목 추가도 가능합니다. 인접 지역을 포함해서 인원이 충분히 모이고, 스터디를 운영해주실 분이 있는 경우에 개설됩니다. 단톡방에서 신처을 받고 있으니 관심있는 분야에 투표해주세요~!",
    date: "2023-12-10",
  },
];
