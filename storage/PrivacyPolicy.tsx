      ...
      >
        ...
        <Container>
          <Text marginBottom="10px">
            ...
            이용자의 권리(개인정보 자기결정권)를 적극적으로 보장하며, 대한민국의
          ...
          <Text marginBottom="10px">
            Vote Helper의 개인정보처리방침을 개정하는 경우 웹사이트
            공지사항(또는 광교 카공스터디 카카오톡오픈대화방 이하 오카방)을
            통하여 공지할 것입니다.
          </Text>
          <Text marginBottom="10px">
            본 방침은 2022년 6월 11일부터 시행됩니다.
          </Text>
          ...
          <Text marginTop="10px">
            또한 서비스 이용과정에서 아래와 같은 정보들이 자동으로 생성되어
            수집될 수 있습니다.
          </Text>
          <List as="ol" marginLeft="1em" styleType="number">
          ...
          <Text>
            Vote Helper는 사용자의 개인정보를 (주)카카오로부터 사용자의 동의에
            따라 제공받고 있습니다.
          </Text>
          ...
          <Text>
            Vote Helper는 사용자의 개인정보를 다음과 같은 목적으로만 사용하며,
            목적이 변경될 경우에는 웹사이트 공지사항(또는 오카방)을 통해 사전에
            고지할 것입니다.
          </Text>
          ...
          <Text>
            ...
            회원자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 분쟁
          ...
          <Text>
            Vote Helper는 사용자의 개인정보를 목적 달성을 위한 기간 동안에만
            제한적으로 처리하며, 목적이 달성되면 사용자의 개인정보는 관계 법령에
            의한 경우가 아니고서는 지체 없이 파기됩니다.
          </Text>
          ...
          <Text>
            Vote Helper는 개인정보 처리업무를 위탁하고 있지 않습니다.{" "}
          </Text>
          ...
          <Text>
            Vote Helper는 원칙적으로 법령에 따른 동의 없이는 사용자의 개인정보를
          ...
          <Text>
            Vote Helper는 사용자의 개인정보를 소중하게 여기고, 개인정보를
            처리함에 있어서 다음 조치를 하고 있습니다.
          </Text>
          <Heading as="h4" size="sm" marginTop="10px">
            카카오에서 제공하는{" "}
          ...
          <Text>
            Vote Helper는 사용자 인증을 카카오 OAuth2.0을 통해 처리하고 있으며,
            따라서 카카오 서비스 연결 동의 페이지에서 동의하신 개인정보(이름,
            프로필 사진) 이외의 개인정보를 일절 제공받지 않습니다.
          </Text>
          <Text>
            또한, 카카오 OAuth2.0 인증 과정에서 Vote Helper는 어떠한 개입도 할
            수 없습니다.
          </Text>
          <Heading as="h4" size="sm" marginTop="10px">
          ...
          <Text>
            Vote Helper는 사용자의 개인정보를 처리하는 직원을 최소화 하며,
            개인정보보호 의무와 보안에 대해 교육하고 있습니다.
          </Text>
          ...
          <Text>
            Vote Helper는 개별적인 맞춤서비스를 제공하기 위해 이용정보를
          ...
          <Text>
            이용자에 의한 본 서비스의 방문 및 이용형태, 보안접속 여부, 등을
          ...
          <Text>
            ...
            통해 쿠키 저장을 거부 할 수 있습니다. 쿠키 저장을 거부할 경우 맞춤형
            서비스 이용에 어려움이 발생할 수 있으며{" "}
            <strong>자동로그인 기능을 지원 받을 수 없습니다</strong>
          </Text>
          ...
          <Text>
            VoteHelper를 사용하는 과정에서 개인정보보호 관련 문의, 불만,
            조언이나 기타 사항은 개인정보 보호책임자로 연락해 주시기 바랍니다.
            Vote Helper는 신속하고 충분한 답변을 드리도록 최선을 다하겠습니다.
          </Text>
          <Heading as="h4" size="sm" marginTop="10px">
            개인정보 보호책임자
          </Heading>
          <List styleType="circle" marginLeft="1em">
            <ListItem>
              ...
              <Text>
                이메일주소 :{" "}
                <a href="mailto:gudfla0814@gmail.com">gudfla0814@gmail.com</a>
              </Text>
            </ListItem>
            <ListItem>
              <Text>성명 : 이승주</Text>
              <Text>
                이메일주소 :{" "}
                <a href="mailto:j44s11@naver.com">j44s11@naver.com</a>
              </Text>
            </ListItem>
          </List>
