  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text marginBottom="10px">
          Vote Helper의 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는
          광교 카공스터디 카카오톡오픈대화방 이하 오카방)을 통하여 공지할
          것입니다.
        </Text>
        <Text marginBottom="10px">
        ...
        <Text marginTop="10px">
          또한 서비스 이용과정에서 아래와 같은 정보들이 자동으로 생성되어 수집될
          수 있습니다.
        </Text>
        <List as="ol" marginLeft="1em" styleType="number">
        ...
        <Text>
          Vote Helper는 사용자의 개인정보를 소중하게 여기고, 개인정보를 처리함에
          있어서 다음 조치를 하고 있습니다.
        </Text>
        <Heading as="h4" size="sm" marginTop="10px">
          카카오에서 제공하는{" "}
        ...
        <Text>
          또한, 카카오 OAuth2.0 인증 과정에서 Vote Helper는 어떠한 개입도 할 수
          없습니다.
        </Text>
        <Heading as="h4" size="sm" marginTop="10px">
        ...
        <Text>
          Vote Helper는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        ...
        <Text>
          VoteHelper를 사용하는 과정에서 개인정보보호 관련 문의, 불만, 조언이나
          기타 사항은 개인정보 보호책임자로 연락해 주시기 바랍니다. Vote
          Helper는 신속하고 충분한 답변을 드리도록 최선을 다하겠습니다.
        </Text>
        <Heading as="h4" size="sm" marginTop="10px">
          개인정보 보호책임자
        </Heading>
