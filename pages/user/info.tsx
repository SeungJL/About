    ...
    <Container>
      ...
      <HStack marginBottom="10px">
        <Box position="relative">
          <ProfileImage src={user.profileImage} alt={user.name} width="80px" />
          <Badge
            position="absolute"
            width="30px"
            height="30px"
          ...
          <Box>
            ...
            <HStack spacing={1}>
              {isStranger(user.role) && (
                <Badge key="stranger" colorScheme="yellow">
                  {role.stranger.display}
                </Badge>
              )}
              {isMember(user.role) && (
                <Badge key="member" colorScheme="green">
                  {role.member.display}
                </Badge>
              )}
              {isPreviliged(user.role) && (
                <Badge key="previliged" colorScheme="red">
                  {role.previliged.display}
                </Badge>
              )}
            </HStack>
          </Box>
