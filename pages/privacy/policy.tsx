  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text marginTop='10px'>또한 서비스 이용과정에서 아래와 같은 정보들이 자동으로 생성되어 수집될 수 있습니다.</Text>
        <List as='ol' marginLeft='1em' styleType='number'>
        ...
        <Heading as='h4' size='sm' marginTop='10px'>홈페이지 회원가입 및 관리</Heading>
        <Text>회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 분쟁 조정을 위한 기록 보존 등을 목적으로 개인정보를 처리합니다.</Text>
        <Heading as='h4' size='sm' marginTop='10px'>민원사무 처리</Heading>
        <Text>민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.</Text>
        <Heading as='h4' size='sm' marginTop='10px'>재화 또는 서비스 제공</Heading>
        <Text>서비스 제공, 콘텐츠 제공 등을 목적으로 개인정보를 처리합니다.</Text>
        <Heading as='h4' size='sm' marginTop='10px'>마케팅에의 활용</Heading>
        <Text>신규 서비스(제품) 개발 및 맞춤 서비스 제공, 인구통계학적 특성에 따른 서비스 제공, 서비스의 유효성 확인, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계 등을 목적으로 개인정보를 처리합니다.</Text>

        <Heading as='h3' size='lg' marginTop='15px'>4. 개인정보의 처리 및 보유기간</Heading>
        <Text>Vote Helper는 사용자의 개인정보를 목적 달성을 위한 기간 동안에만 제한적으로 처리하며, 목적이 달성되면 사용자의 개인정보는 관계 법령에 의한 경우가 아니고서는 지체 없이 파기됩니다.</Text>

        <Heading as='h3' size='lg' marginTop='15px'>5. 개인정보 처리의 위탁</Heading>
        ...
        <Text>Vote Helper는 사용자의 개인정보를 처리하는 직원을 최소화 하며, 개인정보보호 의무와 보안에 대해 교육하고 있습니다.</Text>

        <Heading as='h3' size='lg' marginTop='15px'>8. 개인정보 자동 수집 장치의 설치/운영 및 거부에 관한 사항</Heading>
        <Text>Vote Helper는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.</Text>
        <Text>쿠키는 웹사이트를 운영하는데 이용되는 서버(https)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.</Text>
        <Heading as='h4' size='sm' marginTop='10px'>쿠키의 사용 목적</Heading>
        <Text>이용자에 의한 본 서비스의 방문 및 이용형태, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.</Text>
        <Heading as='h4' size='sm' marginTop='10px'>쿠키의 설치/운영 및 거부</Heading>
        ...
        <Heading as='h4' size='sm' marginTop='15px'>기타 개인정보 침해에 대한 신고나 상담이 필요한 경우에 아래 기관에 문의 가능합니다.</Heading>
        <List styleType='circle' marginLeft='1em'>
          <ListItem>
