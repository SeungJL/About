import { AspectRatio, Heading, useToast, Image, Text, HStack, Container, Box, Divider, Spinner, Tag, Button } from "@chakra-ui/react"
            ...
            <Container key={place._id.toString()}>
              <HStack justifyContent='space-between'>
                <HStack>
                  ...
                  <Heading as='h2' fontSize='lg'>{place.fullname}</Heading>
                </HStack>
              ...
              <HStack alignItems='center'>
                ...
                <NextLink href={`/vote/${date.format('YYYY-MM-DD')}/result/${place._id.toString()}`}>
                  <Button flex='1' height='70'>결과</Button>
                </NextLink>
              </HStack>
            </Container>
          )
