import { Accordion, AccordionButton, AccordionItem, AccordionPanel, Button, Container, HStack, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Spinner, Text, useToast } from "@chakra-ui/react";
    ...
    }
    {
      places && (
        <>
          ...
          />
          <Container>
            <Select id='place' margin='5px 0' placeholder='장소' width='100%' onChange={onChange}>
              {
                places.map((p) => (
